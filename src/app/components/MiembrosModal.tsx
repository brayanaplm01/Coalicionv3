        ...
        >
          ...
          >
            <div className="sticky top-0 left-0 z-20 bg-white/80 backdrop-blur-md rounded-t-2xl mb-2 flex flex-row items-center pt-2 pb-2 px-2" style={{boxShadow:'0 2px 8px 0 #0001'}}>
              <motion.h2
                className="flex-1 text-2xl md:text-3xl font-light text-red-900 mb-0"
                initial="hidden"
                animate="visible"
                variants={sectionVariants}
                custom={0}
              >
                Nuestros <span className="text-red-700 font-normal">17 Miembros Articulados</span>
              </motion.h2>
              <button
                className="text-2xl text-gray-400 hover:text-red-700 focus:outline-none ml-auto"
                onClick={onClose}
                aria-label="Cerrar"
            ...
            <motion.hr className="mb-4 border-red-700" initial="hidden" animate="visible" variants={sectionVariants} custom={1} />
            <motion.p className="mb-4 text-red-900 text-base" initial="hidden" animate="visible" variants={sectionVariants} custom={2}>
            ...
            <motion.div className="mb-6" initial="hidden" animate="visible" variants={sectionVariants} custom={3}>
              <div className="flex flex-col md:flex-row gap-4 mb-4">
                <motion.div
                  className="flex-1 bg-red-50 rounded-xl p-4 flex items-start gap-3"
                  initial={{ opacity: 0, x: 40 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.5, delay: 0.1 }}
                  viewport={{ once: true, amount: 0.3 }}
                >
                  <span className="inline-block w-4 h-4 bg-red-700 rounded-full mt-1" />
                  <div>
                    <div className="font-bold text-red-900">Democracia y Tecnología</div>
                    <div className="text-sm text-red-900">Organizaciones que desarrollan acciones sobre democracia y tecnología</div>
                  </div>
                </motion.div>
                <motion.div
                  className="flex-1 bg-red-50 rounded-xl p-4 flex items-start gap-3"
                  ...
                  viewport={{ once: true, amount: 0.3 }}
                >
                  <span className="inline-block w-4 h-4 bg-red-800 rounded-full mt-1" />
                  <div>
                    <div className="font-bold text-red-900">Contra la Desinformación</div>
                    <div className="text-sm text-red-900">Organizaciones que desarrollan acciones sobre desinformación</div>
                  </div>
                </motion.div>
              </div>
              <div className="font-bold text-red-900 mb-2 flex items-center gap-2">
                <span className="inline-block w-3 h-3 bg-red-900 rounded-full" /> Nuestros Miembros
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-red-900 text-sm">
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={sectionVariants} custom={4}>
                  <div className="font-semibold text-red-700 mb-1">Órgano Electoral</div>
                  <ul className="mb-2 ml-4 list-disc">
                    <li>Tribunal Supremo Electoral - Órgano Electoral Plurinacional (TSE-OEP)</li>
                  </ul>
                  <div className="font-semibold text-red-700 mb-1">Verificadores y Medios</div>
                  <ul className="mb-2 ml-4 list-disc">
                  ...
                  <div className="font-semibold text-red-700 mb-1">Organizaciones de Base y Feministas</div>
                  <ul className="mb-2 ml-4 list-disc">
                    <li>Ciberwarmi</li>
                    <li>Coordinadora de la Mujer</li>
                  </ul>
                  <div className="font-semibold text-red-700 mb-1">Agencias del Sistema de Naciones Unidas</div>
                  <ul className="mb-2 ml-4 list-disc">
                    <li>ONU Mujeres</li>
                    <li>PNUD</li>
                  </ul>
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={sectionVariants} custom={5}>
                  <div className="font-semibold text-red-700 mb-1">Fundaciones Tecnológicas y de Investigación</div>
                  <ul className="mb-2 ml-4 list-disc">
                  ...
                  <div className="font-semibold text-red-700 mb-1">Instituciones Académicas</div>
                  <ul className="mb-2 ml-4 list-disc">
                  ...
                  <div className="font-semibold text-red-700 mb-1">Organizaciones Internacionales</div>
                  <ul className="mb-2 ml-4 list-disc">
