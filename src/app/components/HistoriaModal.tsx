          ...
          >
            <div className="sticky top-0 left-0 z-20 bg-white/80 backdrop-blur-md rounded-t-2xl mb-2 flex flex-row flex-wrap items-end gap-x-2 gap-y-0 pt-2 pb-2 px-2" style={{boxShadow:'0 2px 8px 0 #0001'}}>
              <motion.div
                ...
                custom={0}
              >
                <h2 className="text-2xl md:text-3xl font-light text-red-900 leading-tight mb-0">
                  Nuestra Historia, Misión y
                </h2>
                <span className="text-2xl md:text-3xl font-light text-red-700 leading-tight mb-0">Objetivos</span>
              </motion.div>
              <button
                onClick={onClose}
                className="text-gray-400 hover:text-red-700 text-2xl font-bold focus:outline-none ml-auto"
                aria-label="Cerrar"
                style={{marginLeft:'auto'}}>
                ×
              </button>
            </div>
            <div className="h-1 w-24 bg-red-700 rounded mb-4" />
            {/* Antecedentes */}
            <motion.div className="mb-5" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={sectionVariants} custom={1}>
              <div className="flex items-center gap-2 mb-1">
                <span className="bg-red-700 text-white rounded-full w-7 h-7 flex items-center justify-center text-lg font-bold">•</span>
                <span className="font-bold text-red-900 text-lg">Antecedentes</span>
              </div>
              <div className="text-red-900 text-base mt-1">
            ...
            <motion.div className="mb-5" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={sectionVariants} custom={2}>
              <div className="flex items-center gap-2 mb-1">
                <span className="bg-red-700 text-white rounded-full w-7 h-7 flex items-center justify-center text-lg font-bold">•</span>
                <span className="font-bold text-red-900 text-lg">Iniciativa Global</span>
              </div>
              <div className="text-red-900 text-base mt-1">
            ...
            <motion.div className="mb-5" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={sectionVariants} custom={3}>
              <div className="flex items-center gap-2 mb-1">
                <span className="bg-red-700 text-white rounded-full w-7 h-7 flex items-center justify-center text-lg font-bold">•</span>
                <span className="font-bold text-red-900 text-lg">Nuestra Misión</span>
              </div>
              <div className="text-red-900 text-base mt-1">
            ...
            <motion.div className="mb-5" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={sectionVariants} custom={4}>
              <div className="font-bold text-red-900 text-lg mb-2">Nuestros Objetivos</div>
              <motion.ol
              ...
              >
                <motion.li
                  ...
                  custom={0}
                >
                  <span className="shadow-lg bg-gradient-to-br from-red-700 to-red-500 text-white rounded-xl w-12 h-12 flex items-center justify-center font-extrabold text-2xl border-4 border-white drop-shadow-md select-none transition-transform duration-200">
                    1
                  </span>
                  <div>
                    <span className="font-extrabold text-red-700 text-lg">Fortalecer la Colaboración</span><br />
                    <span className="text-red-900 text-base">Establecer una coalición que reúna a instituciones públicas, sociedad civil, medios de comunicación y socios internacionales para contrarrestar la desinformación electoral de manera coordinada.</span>
                  </div>
                </motion.li>
                <motion.li
                  className="flex items-start gap-4"
                ...
                >
                  ...
                  <div>
                    <span className="font-extrabold text-red-700 text-lg">Desarrollo de Capacidades</span><br />
                    <span className="text-red-900 text-base">Colaborar en iniciativas que fortalezcan la alfabetización mediática digital, aumenten la conciencia pública y aseguren la integridad de la información electoral a través de herramientas innovadoras.</span>
                  </div>
                </motion.li>
                <motion.li
                  className="flex items-start gap-4"
                ...
                >
                  ...
                  <div>
                    <span className="font-extrabold text-red-700 text-lg">Integridad de la Información</span><br />
                    <span className="text-red-900 text-base">Mitigar el impacto de la desinformación y los discursos tóxicos, especialmente hacia las mujeres y poblaciones vulnerables, protegiendo la estabilidad democrática del país.</span>
                  </div>
                </motion.li>
              </motion.ol>
            </motion.div>
            ...
            <motion.div className="mb-2" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={sectionVariants} custom={5}>
              <div className="font-bold text-red-900 text-lg mb-2">Ejes de Trabajo</div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                <motion.div
                  className="bg-red-50 border border-red-700 rounded-lg p-3"
                  initial={{ opacity: 0, x: 40 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.5, delay: 0.1 }}
                  viewport={{ once: true, amount: 0.3 }}
                >
                  <div className="font-bold text-red-700 mb-1">Democracia y Tecnología</div>
                  <div className="text-red-900 text-base">Organizaciones que desarrollan acciones sobre democracia y tecnología</div>
                </motion.div>
                <motion.div
                  className="bg-red-50 border border-red-700 rounded-lg p-3"
                  initial={{ opacity: 0, x: 40 }}
                  ...
                  viewport={{ once: true, amount: 0.3 }}
                >
                  <div className="font-bold text-red-700 mb-1">Contra la Desinformación</div>
                  <div className="text-red-900 text-base">Organizaciones que desarrollan acciones sobre desinformación</div>
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
